...
class Locations extends CI_Controller {	
	...
	{		
		...
		remove_ssl();
                ...
                //check admin access
		$this->load->model(array('Location_model','Group_model','Product_model','Category_model','Shop_model','Search_model'));
                ////////////////////////////////////////////////////////////////
                $this->language     = $this->session->userdata('language');
                $this->data_shop    = $this->session->userdata('shop');
                ////////////////////////////////////////////////////////////////
                $this->lang->load('location',  $this->language);
	...
	function index()
	{
		...
		$data['locations']	= $this->Location_model->get_countries();
                ...
                if($this->input->post('search_term')){
                    $data['found_invoices']     = $this->Search_model->find_invoices($this->input->post('search_term'), 'invoice_number', 'desc', 15, 0,$this->data_shop);
                    $data['found_products']     = $this->Search_model->find_products($this->input->post('search_term'), 'id', 'desc', 15, 0,$this->data_shop);
                    $data['found_customers']    = $this->Search_model->find_customers($this->input->post('search_term'), 'id', 'desc', 15, 0,$this->data_shop);
                    $data['found_orders']       = $this->Search_model->find_orders($this->input->post('search_term'), 'order_number', 'desc', 15, 0,$this->data_shop);
                }
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
