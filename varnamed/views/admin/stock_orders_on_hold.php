...
<table class="table table-striped">
	...
	<tr>
		...
		<td style="white-space:nowrap"><?php echo $order->supplier_name.', '.$order->supplier_name; ?></td>
                <td style="white-space:nowrap"><?php echo $order->arrival_date; ?></td>                
		<td>
                    <a class="btn btn btn-small" style="float:right;"href="<?php echo site_url($this->config->item('admin_folder').'/stock/view/'.$order->id);?>"><i class="icon-eye-open"></i> <?php echo lang('form_view')?></a>
		</td>
                <td>
                    <a class="btn btn-success btn-small" style="float:right;"href="<?php echo site_url($this->config->item('admin_folder').'/stock/checkout/'.$order->id);?>"><i class="icon-ok"></i> <?php echo lang('checkout')?></a>
		</td>
	</tr>
    <?php endforeach; ?>
    </tbody>
