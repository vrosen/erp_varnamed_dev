...
$description		= array('name'=>'description', 'value' => set_value('description', $description));
$details		= array('name'=>'details', 'value' => set_value('details', $details));
$price_details		= array('name'=>'price_details', 'value' => set_value('price_details', $price_details));
