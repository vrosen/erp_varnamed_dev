<?php require('header.php'); 
	...
	function sort_url($lang, $by, $sort, $sorder, $code, $admin_folder)
	{
		...
		$return = site_url($admin_folder.'/stock/backorder/'.$by.'/'.$sort.'/'.$code);
...
<table class="table table-striped">
    <h3><?php echo lang('backorder_products'); ?></h3>
    <thead>
		<tr>
			
                    
                        <th><?php echo lang('product_nr'); ?></th>
                        <th><?php echo lang('backorder_items'); ?></th>
...
<table class="table table-striped">
    <h3><?php echo lang('backorder_orders'); ?></h3>
    <thead>
		<tr>
