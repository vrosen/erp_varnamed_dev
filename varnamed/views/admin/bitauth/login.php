...
<?php
	...
	echo form_open($this->config->item('admin_folder').'/example/login');
	...
	echo '<div id="bottom">';
	echo '<span style="float: right;">'.anchor($this->config->item('admin_folder').'/example/register', 'Register').'</span>';
