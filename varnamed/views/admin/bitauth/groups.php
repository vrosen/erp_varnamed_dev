...
<body>
	<?php
		...
		foreach($groups as $_group)
		{
			...
			{
				$actions = anchor($this->config->item('admin_folder').'/example/edit_group/'.$_group->group_id, 'Edit Group');
			}
		...
		echo anchor($this->config->item('admin_folder').'/example', 'View Users');
		if($bitauth->is_admin())
		{
			echo '<br/>'.anchor($this->config->item('admin_folder').'/example/add_group', 'Add Group');
		}
		echo '</div>';
	?>
</body>
