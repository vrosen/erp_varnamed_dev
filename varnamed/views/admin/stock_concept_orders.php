<?php require('header.php'); 
	...
	function sort_url($lang, $by, $sort, $sorder, $code, $admin_folder)
	{
		...
		$return = site_url($admin_folder.'/stock/concept_orders/'.$by.'/'.$sort.'/'.$code);
...
<table class="table table-striped">
    <h3><?php echo lang('draft_orders_table'); ?></h3>
    <thead>
		<tr>
			...
			<th><?php echo sort_url('order', 'order_number', $sort_by, $sort_order, $code, $this->config->item('admin_folder')); ?></th>
                        ...
                        <th><?php echo sort_url('order_country', 'ship_country_code', $sort_by, $sort_order, $code, $this->config->item('admin_folder')); ?></th>
                        ...
                        <th><?php echo sort_url('payment_method', 'payment_method', $sort_by, $sort_order, $code, $this->config->item('admin_folder')); ?></th>
...
<table class="table table-striped">
        <h3><?php echo lang('blocked_orders_table'); ?></h3>
    <thead>
		<tr>
...
<table class="table table-striped">
        <h3><?php echo lang('draft_returns_table'); ?></h3>
    <thead>
		<tr>
