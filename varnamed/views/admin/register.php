...
<head>
	...
	<title>Varnamed | <?php echo $title; ?></title>
</head>
<body>
	<?php
		...
		echo '<caption>Varnamed : '.$title.'</caption>';
		...
		{
			echo anchor($this->config->item('admin_folder').'/admin/logout', 'Logout', 'style="float: right;"');
		}
		else
		{
			echo anchor($this->config->item('admin_folder').'/admin/login', 'Login', 'style="float: right;"');
		}
		echo '</div>';
