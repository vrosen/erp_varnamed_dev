<?php require('header.php'); 
	...
	function sort_url($lang, $by, $sort, $sorder, $code, $admin_folder)
	{
		...
		$return = site_url($admin_folder.'/stock/old_dispatches/'.$by.'/'.$sort.'/'.$code);
...
?>
<?php echo form_dropdown('month', $period, 'current',$class_1); ?>&nbsp;
<?php echo form_dropdown('year', $period_y, 'current',$class); ?>
<table class="table table-striped">
    <h3><?php echo lang('old_deliveries_table'); ?></h3>
    <thead>
		<tr>
			...
			<th><?php echo sort_url('order', 'order_number', $sort_by, $sort_order, $code, $this->config->item('admin_folder')); ?></th>
                        ...
                        <th><?php echo lang('shipp_num'); ?></th>    
                        <th><?php echo lang('work_again'); ?></th>    
			<th></th>
	    </tr>
	</thead>
	...
	<tr>
		...
		<td><?php echo $order->order_number; ?></td>
                ...
                <td></td>
                <td>
			<a href="<?php echo site_url($this->config->item('admin_folder').'/orders/view/'.$order->id);?>"><?php echo lang('work_again')?></a>
		</td>
	</tr>
    <?php endforeach; ?>
    </tbody>
