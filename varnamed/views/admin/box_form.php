...
$description		= array('name'=>'description', 'id'=>'description', 'value' => set_value('description', $description));
$details		= array('name'=>'details', 'id'=>'details', 'value' => set_value('details', $details));
$price_details		= array('name'=>'price_details', 'id'=>'price_details', 'value' => set_value('price_details', $price_details));
...
<?php echo form_open_multipart($this->config->item('admin_folder').'/boxes/form/'.$id); ?>
	...
	<?php echo form_input($details); ?>
        ...
        <label for="price_details"><?php echo lang('price_details');?> </label>
	<?php echo form_input($price_details); ?>
