<?php require('header.php'); 
	...
	function sort_url($lang, $by, $sort, $sorder, $code, $admin_folder)
	{
		...
		$return = site_url($admin_folder.'/stock/dispatch/'.$by.'/'.$sort.'/'.$code);
...
<table class="table table-striped">
    <h3><?php echo lang('new_deliveries_table'); ?></h3>
    <thead>
		<tr>
			...
			<th><?php echo sort_url('order', 'order_number', $sort_by, $sort_order, $code, $this->config->item('admin_folder')); ?></th>
                        ...
                        <th><?php echo sort_url('entered_on', 'entered_on', $sort_by, $sort_order, $code, $this->config->item('admin_folder')); ?></th>
                        
			<th><?php echo sort_url('ordered_on','ordered_on', $sort_by, $sort_order, $code, $this->config->item('admin_folder')); ?></th>
                        <th><?php echo lang('new_date'); ?></th>
...
<table class="table table-striped">
    <h3><?php echo lang('direct_deliveries_table'); ?></h3>
    <thead>
		<tr>
			...
			<th><?php echo sort_url('ordered_on','ordered_on', $sort_by, $sort_order, $code, $this->config->item('admin_folder')); ?></th>
                        <th><?php echo sort_url('expected_delivery','delivery_date', $sort_by, $sort_order, $code, $this->config->item('admin_folder')); ?></th>
...
<table class="table table-striped">
    <h3><?php echo lang('complete_deliveries_table'); ?></h3>
    <thead>
		<tr>
			...
			<th><?php echo sort_url('ordered_on','ordered_on', $sort_by, $sort_order, $code, $this->config->item('admin_folder')); ?></th>
                        <th><?php echo sort_url('shipping_date','shipped_on', $sort_by, $sort_order, $code, $this->config->item('admin_folder')); ?></th>
	...
	<tr>
		...
		<td style="white-space:nowrap"><?php echo date('m/d/y h:i a', strtotime($order->ordered_on)); ?></td>
                 ...
                 <td><?php echo $order->shipped_on; ?></td>
                 <td><?php echo $order->shipping; ?></td>
                <td>
			<a class="btn btn-small" style="float:right;"href="<?php echo site_url($this->config->item('admin_folder').'/orders/view/'.$order->id);?>"><i class="icon-search"></i> <?php echo lang('form_view')?></a>
		</td>
...
<table class="table table-striped">
    <h3><?php echo lang('fixed_deliveries_table'); ?></h3>
    <thead>
		<tr>
