...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="4"></td><td align="left"><font face="sans-serif"  size="2"><?php echo $this->config->item('currency_symbol_uk').' '.str_replace('.',',',$product['product_total']); ?></font></td>
        </tr>
		<?php }else { ?>
        <tr>
            <td><font face="sans-serif"  size="2"><?php echo $product['code'] ?></font></td>
            ...
            <td colspan="4"></td><td align="left"><font face="sans-serif"  size="2"><?php echo $this->config->item('currency_symbol').' '.str_replace('.',',',$product['product_total']); ?></font></td>
        </tr>
		<?php } ?>
        <?php endforeach; ?>
    </tbody>
<?php if($cur_country == 'UK'){ ?>
    <tfoot>
        <tr>
            ...
            <td colspan="4"></td>
            <td align="left"><font face="sans-serif"  size="2"><?php echo $this->config->item('currency_symbol_uk').' '.str_replace('.',',',$shipping_costs_value); ?></font></td>
        </tr>
        <tr>
            <td colspan="4"></td>
            <td><font face="sans-serif"  size="2"><?php echo $total_price_net; ?>:</font></td>
            <td colspan="4"></td>
            <td align="left"><font face="sans-serif"  size="2"><?php echo $this->config->item('currency_symbol_uk').' '.str_replace('.',',',$totalnet); ?></font></td>
        </tr>
        <tr>
            <td colspan="4"></td>
            <td><font face="sans-serif"  size="2"><?php echo str_replace('.00', '%', $vat_index).' '.$vat; ?>:</font></td>
            <td colspan="4"></td>
            <td align="left"><font face="sans-serif"  size="2"><?php echo $this->config->item('currency_symbol_uk').' '.str_replace('.',',',$vat_value); ?></font></td>
        </tr>
        <tr>
            <td colspan="4"></td>
            <td><font face="sans-serif"  size="2"><b><?php echo $total_price; ?>:</b></font></td>
            <td colspan="4"></td>
            <td align="left"><font face="sans-serif"  size="2"><b><?php echo $this->config->item('currency_symbol_uk').' '.str_replace('.',',',$totalgross); ?></b></font></td>
        </tr>
        </tfoot>
...
<?php }else { ?>
    <tfoot>
        <tr>
            ...
            <td><font face="sans-serif"  size="2"><?php echo $shipping_costs; ?>:</font></td>
            <td colspan="4"></td>
            <td align="left"><font face="sans-serif"  size="2"><?php echo $this->config->item('currency_symbol').' '.str_replace('.',',',$shipping_costs_value); ?></font></td>
        </tr>
        <tr>
            <td colspan="4"></td>
            <td><font face="sans-serif"  size="2"><?php echo $total_price_net; ?>:</font></td>
            <td colspan="4"></td>
            <td align="left"><font face="sans-serif"  size="2"><?php echo $this->config->item('currency_symbol').' '.str_replace('.',',',$totalnet); ?></font></td>
        </tr>
        <tr>
            <td colspan="4"></td>
            <td><font face="sans-serif"  size="2"><?php echo str_replace('.00', '%', $vat_index).' '.$vat; ?>:</font></td>
            <td colspan="4"></td>
            <td align="left"><font face="sans-serif"  size="2"><?php echo $this->config->item('currency_symbol').' '.str_replace('.',',',$vat_value); ?></font></td>
        </tr>
        <tr>
            <td colspan="4"></td>
            <td><font face="sans-serif"  size="2"><b><?php echo $total_price; ?>:</b></font></td>
