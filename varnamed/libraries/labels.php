...
class Labels {
	...
	function output($invoice_number = false,$addresses=array())
	{
		...
		if (count($this->addresses)) {
			switch ($this->format) {
				case "word": { $output = $this->generate_labels_word($invoice_number);  break; }
	...
	function generate_labels_word($invoice_number) 
	{
		...
		$this->output_file($invoice_number, $output);
