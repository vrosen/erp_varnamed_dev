...
Item.prototype.getPosition = function() {
  ...
  //var layoutSize = this.layout.size; MD comments
...
Rect.prototype.canFit = function( rect ) {
  return this.width >= (rect.width - 6) && (this.height >= rect.height - 6);
};
...
Packery.prototype.fit = function( elem, x, y ) {
  ...
  item.moveTo( item.placeRect.x, item.placeRect.y );  /*MD comment moveTo*/
